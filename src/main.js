...
var myBott = ['ua1cb6e845fe8f2646fe8a5c598a5c5911841fa','u00f827ce6641038d7c9b6704a9777dfa'];//TARO MID LU DISINI SUPAYA BISA PKE COMMAND STAFF

const myBot = ['ua1cb6e845fe8f2646fe8a5c598a5c5911841fa','u00f827ce6641038d7c9b6704a9777dfa'];//TARO MID LU DISINI
    ...
    poll(operation) {
	    ...
	    this.textMessage("0103",seq,operation.param2,1);
          ...
          if(operation.type == 15 && this.stateStatus.bmsg == 1) {
             ...
             out.text = "อ่าวตายห่าชะครับท่านผู้ชม..."
            ...
            if(operation.type == 17 && this.stateStatus.bmsg == 1) {
               ...
               kam.text = "ยินดีต้อนรับคับไอ้บักหำ\n\n[By.Gu Min Hack Bot]"
           ...
           if(operation.type == 16 && this.stateStatus.bmsg == 1) {
             ...
             itil.text = "กำแท้ๆเลยเตะกันทำมั้ยเนี้ยคับ..."
           ...
           if(operation.type == 19 && this.stateStatus.bmsg == 1 && !isAdminOrBot(operation.param2)) {
             ...
             plerrr.text = "SELFBOT MIN HACK BOT"
           ...
           if(seq.contentType == 13 && this.sendStaff == 2 && isAdminOrBot(seq.from))
{
    ...
    await this._sendMessage(seq,'Sukses Menghapus Staff~');
        ...
        if(txt == 'บอท') {
           if(isAdminOrBot(seq.from) || isStaffOrBot(seq.from)) {
            this._sendMessage(seq, 'มึงนี้ก็เรียกจัง\n\nกูยังอยู่ยังไม่ตาย..ครับบักหำแอดมินบอท');
           }
        }
        ...
        if(txt == 'speed') {
            ...
            await this._sendMessage(seq, `${rtime} ได้แค่นี้แหละหำ`);
        }
...
let { listMember } = await this.searchGroup(seq.to);
     const mentions = await this.mention(listMember);
        ...
        if(txt == 'นับ') {
            ...
            this.checkReader = []
            this._sendMessage(seq, `อ่าาารอหน่อย....อะทีนี้ก็พิมพ์📌อ่าน📌`);
        }  
        ...
        if(txt == 'me') {
           this._sendMessage(seq,'บักนี้หล่อครับผม');
           seq.contentType=13;
           seq.contentMetadata = { mid: 'ua1cb6e845fe8f2646fe8a5c598a5c5911841fa' };
           this._client.sendMessage(1, seq);
        }
